...
module Eodhd
  class Processor
    ...
    def fetch_exchanges_list(api:, io:)
      relative_path = Eodhd::Path.exchanges_list

      if file_stale?(io: io, relative_path: relative_path)
    ...
    def file_stale?(io:, relative_path:)
