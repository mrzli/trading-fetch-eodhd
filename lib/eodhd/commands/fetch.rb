    ...
    module Fetch
      ...
      def run
        ...
        when "intraday"
          ...
          runner.run_intraday(recheck_start_date: recheck_start_date, parallel: parallel, workers: workers)
        else
