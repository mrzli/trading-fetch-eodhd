...
require_relative "../../../../lib/eodhd/process/intraday/input_merger"

describe Eodhd::InputMerger do
  it "concats when disjoint" do
    ...
    merged = Eodhd::InputMerger.merge([a, b])
  ...
  it "handles nil and empty inputs" do
    merged = Eodhd::InputMerger.merge([nil, [], [{ timestamp: 1, v: :x }]])
