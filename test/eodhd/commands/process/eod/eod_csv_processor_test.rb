...
require_relative "../../../../../lib/eodhd/commands/process/eod/eod_csv_processor"

describe Eodhd::Commands::Process::Eod::EodCsvProcessor do
  it "omits Adjusted_close and split-adjusts prior rows" do
    ...
    processor = Eodhd::Commands::Process::Eod::EodCsvProcessor.new(log: Logging::NullLogger.new)
